    ...
    public void subscribe(String filter) throws CanalClientException{
        ...
        while(times < retryTimes){
            try{
                ...
                logger.warn(String.format("something goes wrong when subscribing from server: %s", currentConnector != null ? currentConnector.getAddress() : "null"), t);
                times++;
                restart();
    ...
    public void unsubscribe() throws CanalClientException{
        ...
        while(times < retryTimes){
            try{
                ...
                logger.warn(String.format("something goes wrong when unsubscribing from server:%s", currentConnector != null ? currentConnector.getAddress() : "null"), t);
                times++;
                restart();
                logger.info("restart the connector for next round retry.");
            }
    ...
    public Message get(int batchSize) throws CanalClientException{
        ...
        while(times < retryTimes){
            try{
                ...
                logger.warn(String.format("something goes wrong when getting data from server:%s", currentConnector != null ? currentConnector.getAddress() : "null"), t);
                times++;
                restart();
                logger.info("restart the connector for next round retry.");
            }
    ...
    public Message getWithoutAck(int batchSize) throws CanalClientException{
        ...
        while(times < retryTimes){
            try{
                ...
                logger.warn(String.format("something goes wrong when getWithoutAck data from server:%s", currentConnector.getAddress()), t);
                times++;
                restart();
                logger.info("restart the connector for next round retry.");
            }
    ...
    public void rollback(long batchId) throws CanalClientException{
        ...
        while(times < retryTimes){
            try{
                ...
                logger.warn(String.format("something goes wrong when rollbacking data from server:%s", currentConnector.getAddress()), t);
                times++;
                restart();
                logger.info("restart the connector for next round retry.");
            }
    ...
    public void ack(long batchId) throws CanalClientException{
        ...
        while(times < retryTimes){
            try{
                ...
                logger.warn(String.format("something goes wrong when acking data from server:%s", currentConnector.getAddress()), t);
                times++;
                restart();
                logger.info("restart the connector for next round retry.");
            }
